...
The repository keeps portable interview assets separate from product execution. The current code is still a scaffold; this document freezes the boundaries for the text-first MVP rather than claiming these runtime features are implemented.
