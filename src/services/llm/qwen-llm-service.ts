  ...
  return [
    {
      ...
      content: [
        ...
        "Do not use ANSWER_COMPLETE_BUT_RAMBLING merely because an answer is long, detailed, imperfectly organized, or includes relevant technical context. If any requested dimension is still missing, the answer is clearly unfinished, or the later material may still support the answer, use the ordinary issue or fail-open rules instead.",
